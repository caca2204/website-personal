...
// Menghapus pesanan jika permintaan delete diberikan
...
// Memperbarui status pembayaran jika permintaan update diberikan
   ...
   <div class="box-container">
      ...
      ?>
         <div class="box">
            ...
            <p>Total Harga: <span>Rp.<?= formatRupiah($fetch_orders['total_price']); ?></span></p>
            <p>Metode Pembayaran: <span><?= $fetch_orders['method']; ?></span></p>
            <p>Catatan Pembeli: <span><?= $fetch_orders['note']; ?></span></p>
            <p>Status Pembayaran: <span style="color:<?php echo ($fetch_orders['payment_status'] == 'pending') ? 'red' : 'green'; ?>"><?= $fetch_orders['payment_status']; ?></span></p>
      ...
      <?php
         ...
         echo '<p class="empty">Tidak ada pemesanan!!</p>';
      }
      ?>
   </div>
</section>
