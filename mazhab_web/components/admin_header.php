...
<header class="header">
   ...
   <section class="flex">
      ...
      <a href="../admin/dashboard.php" class="logo">Mazhab<span>Admin</span></a>
      ...
      <div class="profile">
         ...
         <a href="../components/admin_logout.php" class="delete-btn" onclick="return confirm('keluar dari website?');">logout</a> 
      </div>
